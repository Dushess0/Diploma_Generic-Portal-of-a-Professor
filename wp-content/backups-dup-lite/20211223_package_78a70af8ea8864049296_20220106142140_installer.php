...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211223_package_78a70af8ea8864049296_20220106142140_archive.zip';
	const ARCHIVE_SIZE		 = '85090693';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '78a70af-06142140';
    const SECONDARY_PACKAGE_HASH = 'fee6d18-06142140';
	const VERSION			 = '1.4.3';
